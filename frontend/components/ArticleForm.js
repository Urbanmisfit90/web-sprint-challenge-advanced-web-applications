...
export default function ArticleForm(props) {
  ...
  useEffect(() => {
    ...
    if (props.article) setValues(props.article);
  ...
  const isDisabled = () => {
    ...
    return !(values.text.length && values.title.length && values.topic.length);
  };
  ...
  return (
    ...
    <form id="form" onSubmit={onSubmit}>
      ...
      <div className="button-group">
        ...
        {props.article && (
          <button onClick={props.setCurrentArticleIdUndefined}>
            Cancel edit
          </button>
        )}
      </div>
